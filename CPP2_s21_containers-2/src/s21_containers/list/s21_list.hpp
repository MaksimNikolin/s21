#ifndef SRC_S21_CONTAINERS_LIST_S21_LIST_HPP
#define SRC_S21_CONTAINERS_LIST_S21_LIST_HPP
...
class list {
 ...
 public:
  ...
  void splice(const_iterator pos,
              list& other);  // moves elements from another list
  ...
  void push_front(
      const_reference value);  // inserts an element to the beginning
...
#endif  // SRC_S21_CONTAINERS_LIST_S21_LIST_HPP