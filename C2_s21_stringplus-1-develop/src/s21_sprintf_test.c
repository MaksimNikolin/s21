...
// Unit tests are made in the form of loops to cover more than 80% of the test
// files themselves. The condition of the problem was misunderstood.
  ...
  for (int i = 0; i < 3; i++)
    for (int j = 0; j < 3; j++)
      for (int k = 0; k < 2; k++)
        for (int l = 0; l < 3; l++)
          for (int m = 0; m < 3; m++)
            ck_assert_int_eq(s21_sprintf(str1, "%s", "HELLO 888"),
                             sprintf(str2, "%s", "HELLO 888"));
}
END_TEST
  ...
  for (int i = 0; i < 3; i++)
    for (int j = 0; j < 3; j++)
      for (int k = 0; k < 2; k++)
        for (int l = 0; l < 3; l++)
          for (int m = 0; m < 3; m++)
            ck_assert_int_eq(s21_sprintf(str1, "%s%s%s", "HELLO", " ", "999"),
                             sprintf(str2, "%s%s%s", "HELLO", " ", "999"));
}
END_TEST
    ...
    for (int j = 0; j < 3; j++)
      for (int k = 0; k < 2; k++)
        for (int l = 0; l < 3; l++)
          for (int m = 0; m < 3; m++)
            for (int n = 0; n < 3; n++)
              ck_assert_int_eq(s21_sprintf(str1, format, "HELLO 000"),
                               sprintf(str2, format, "HELLO 000"));
}
END_TEST
